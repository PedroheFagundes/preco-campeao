const products = [
  {
    ...
    price: [
      ...
      [4.69, "R&E Mercado", "11-12-2021", new Date().setHours(0,0,0,0) <= new Date("11-12-2021").getTime() ? "Válido" : "Expirado"],
      [3.19, "Serra Azul", "11-15-2021", new Date().setHours(0,0,0,0) <= new Date("11-15-2021").getTime() ? "Válido" : "Expirado"],
      [4.69, "Tio Dongo", "11-12-2021", new Date().setHours(0,0,0,0) <= new Date("11-12-2021").getTime() ? "Válido" : "Expirado"],
    ],
