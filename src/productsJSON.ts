const products = [
  ...
  },
  {
    ...
    price: [
      [74.90, "Atacadão", "11-14-2021", new Date().setHours(0,0,0,0) <= new Date("11-14-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Big Blue", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Bramil", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Casa Friburgo", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Cavalo Preto", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Gama", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Pepê & Gabriel", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "R&E Mercado", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Serra Azul", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
      [0.09, "Tio Dongo", "12-12-2021", new Date().setHours(0,0,0,0) <= new Date("12-12-2021").getTime() ? "Válido" : "Expirado"],
    ],
    category: "massa francês",
    image: "mistura-pao-frances-veramix.png",
  }
